...
<html>
	<head>
		<title><spring:message code="payment_l_printGuarantee"/></title>
	...
	<body>
		...
		<div class="row">
			<div class="col-md-4">
				<button id="paymentAddBt" type="button" class="btn btn-default payment-button"><spring:message code="payment_l_submitGuarantee"/></button>
			</div>
			<div class="col-md-4">
