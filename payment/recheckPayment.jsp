...
<html>
	<head>
		<title><spring:message code="payment_l_rechekPayment"/></title>
	...
	<body>
		<div class="payment-path">
			<ol class="breadcrumb ">
				<li class="active"><spring:message code="payment_l_rechekPayment"/></li>
			</ol>
		</div>
		<div class="row">
			<div class="col-md-12" role="main">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="recheckForm" class="form-horizontal" action="<c:url value="/payment2/handleTask/complete"/>" method="POST">
							...
							<jsp:include page="fragment/handleTask.jsp" flush="true">
								<jsp:param name="process" value="recheck"/> 
								<jsp:param name="formId" value="recheckForm"/> 
						...
						$.ajax({
			                ...
			                data: $(form).serialize(),
			                   ...
			                   if(data.success == true){
		                    		swal({   
		                    			title:  '<spring:message code="payment_m_info11"/>',   
