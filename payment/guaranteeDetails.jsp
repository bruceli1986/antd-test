...
<html>
	<head>
		<title><spring:message code="payment_l_guaranteeDetails"/></title>
		<style>
	...
	<body>
		<div class="payment-path">
			<ol class="breadcrumb">
			  <li class="active"><spring:message code="payment_l_guaranteeDetails"/></li>
			</ol>
		</div> 
			...
			<div class="col-md-12" role="main"> 
				...
				<c:if test="${isComplete}">
					<div class="row">
						...
						<div class="col-md-3">
							<button type="button" class="btn btn-default payment-button" href="/qdp/page/payment/guaranteeReportForm.jsp" data-businesskey="${businessId}"  data-processinstanceid="${processInstanceId}" data-toggle="modal" data-target="#reportCodeModal"><spring:message code="payment_l_printGuarantee"/></button>
						</div>
					</div>
				</c:if>
		...
		<c:if test="${isComplete}">
			<div class="modal fade" id="reportCodeModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
